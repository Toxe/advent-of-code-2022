...
void Coords::move_north(const int distance) { move_up(distance); }
void Coords::move_south(const int distance) { move_down(distance); }
void Coords::move_west(const int distance) { move_left(distance); }
void Coords::move_east(const int distance) { move_right(distance); }
